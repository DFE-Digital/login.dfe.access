const { getUsersOfServicePagedV2 } = require("./../../infrastructure/data");
...
const listUsersOfServiceWithRoles = async (req, res) => {
  ...
  const pageOfUserServices = await getUsersOfServicePagedV2(
    sid,
    oid,
    roleIds ? roleIds.split(",") : null,
    pageNumber,
    pageSize,
  );
...
module.exports = listUsersOfServiceWithRoles;
